...
def test_compare_anw_single_voice_notes_beam(load_single_voice_compare_resources):
...
def test_compare_anw_single_voice_notes_duration(load_single_voice_compare_resources):
